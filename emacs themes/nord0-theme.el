;;; nord0-theme.el --- A mostly colorless theme
...
;; URL: https://github.com/lethom/nord0-theme.el
...
;; nord0 has two main source of inspiration: nofrils[1], an extremely
...
(deftheme nord0 "A mostly colorless theme")

(let ((nord0   "#1e222c") ; polar night
      (nord1   "#3B4252")
      (nord2   "#434C5E")
      (nord3   "#4C566A")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:background ,nord0 :foreground ,nord4 :box (:line-width 3 :color ,nord0)))))
