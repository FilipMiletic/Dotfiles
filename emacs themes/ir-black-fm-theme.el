...
(let ((*background-color*   "#090909")
      ...
      (*keywords*           "#8891cd")     ;; (*keywords*           "#7094b8")
      (*light-purple*       "#FFCCFF")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground, "#12e63c"))))
   `(font-lock-comment-face ((t (:foreground, "#12e63c"))))
   ...
   `(font-lock-string-face ((t (:foreground, *operators*))))
